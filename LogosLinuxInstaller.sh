...
if [ -z "${LAUNCHER_TEMPLATE_URL}" ]; then LAUNCHER_TEMPLATE_URL="https://raw.githubusercontent.com/ferion11/LogosLinuxInstaller/Launcher-Template.sh"; export LAUNCHER_TEMPLATE_URL; fi
if [ -z "${CONTROL_PANEL_TEMPLATE_URL}" ]; then CONTROL_PANEL_TEMPLATE_URL="https://raw.githubusercontent.com/ferion11/LogosLinuxInstaller/controlPanel-Template.sh"; export CONTROL_PANEL_TEMPLATE_URL; fi
