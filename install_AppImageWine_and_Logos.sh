...
export THIS_SCRIPT_VERSION="v2.6-rc0"

# try to workaround some pipes issues, setting SIGPIPE disposition to SIG_IGN:
trap '' pipe
...
# back to 2020 Jul 23 release of winetricks, not more of the last git random broken fun:
