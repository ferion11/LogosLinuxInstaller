...
export THIS_SCRIPT_VERSION="v2.26-rc1"

#=================================================
# version of Logos from: https://wiki.logos.com/The_Logos_9_Beta_Program
if [ -z "${LOGOS64_URL}" ]; then export LOGOS64_URL="https://downloads.logoscdn.com/LBS9/Installer/9.4.0.0009/Logos-x64.msi" ; fi
...
installationChoice="$(zenity --width=700 --height=310 \
	...
	FALSE "1- Install LogosBible64 using Wine64 ${WINE64_APPIMAGE_VERSION} plain AppImage without dependencies." \
