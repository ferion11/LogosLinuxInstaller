...
# Updated by M0RVJ for Logos 10
export THIS_SCRIPT_VERSION="v10.alpha16"

#=================================================
# version of Logos from: https://clientservices.logos.com/update/v1/feed/eden/beta.xml
if [ -z "${LOGOS64_URL}" ]; then export LOGOS64_URL="https://downloads.logoscdn.com/LBS10/InstallerBeta/10.0.0.0149/Logos-x64.msi" ; fi
...
if [ -z "${WINETRICKS_URL}" ]; then export WINETRICKS_URL="https://raw.githubusercontent.com/austin987/winetricks/foss_corefonts/src/winetricks" ; fi
...
gtk_continue_question "Now the script will create and configure the Wine Bottle at ${WINEPREFIX}. Please agree to install Mono (Older versions of Logos didn't need this. Do you wish to continue?"
echo "================================================="
...
#Disables install of mono but mono is useful for Logos10 install
#echo "================================================="
...
if [ -z "${WINETRICKS_UNATTENDED}" ]; then
	echo "================================================="
#	winetricks_install foss_corefonts
#	echo "================================================="
...
#	winetricks_install dotnet48
	...
	echo "================================================="
#	winetricks_install -q foss_corefonts
	echo "================================================="
